...
export default function ProgramView() {
  ...
  // //i want to get /specialistDs/program/view?programId=${program._TrainingProgramId}&specialistId=${program.createdBy} perams Ids
  ...
  //   // You can now use these IDs for API calls or other logic
  // }, [searchParams]);

  // console.log('training ProgramId:', programId);
  // console.log('Specialist ID:', specialistId);

  // const { data } = useGetAllProgramBySpecialistIdQuery({
  //   programId,
  //   specialistId,
  // });
  // const programs = data || [] // Use an empty array if data is undefined;
