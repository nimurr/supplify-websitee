...
export default function MealPlanProtocol() {
  ...
  const filteredPlanes = planeData?.data?.attributes?.results || [];
  ...
  useEffect(() => {
    ...
    const protocolId = searchParams.get('id');  // Get the 'id' from URL search params
    setId(protocolId);
